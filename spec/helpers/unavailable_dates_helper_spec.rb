...
describe UnavailableDatesHelper do
  ...
  #     Reservation.make(:dates => [3.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 5.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 7.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 9.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 11.days.from_now, :creator => @me, :parent => @board)
  # 
  ...
  #     UnavailableDate.make(:date => 3.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 5.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 7.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 9.days.from_now, :creator => @me, :parent => @board)
  #     UnavailableDate.make(:date => 11.days.from_now, :creator => @me, :parent => @board)
