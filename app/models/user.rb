...
class User < ActiveRecord::Base
  ...
  has_many  :invoices, :foreign_key => "responsible_user_id"
  ...
  attr_accessible :email, :password, :password_confirmation, :terms_of_service, :image_attributes, :description, :website, :friendly, :pickup_time_ids, :user_location_attributes, :location_id
